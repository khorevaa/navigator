...
Функция СтруктураМетаданныхКонфигурации(ПараметрыФормирования = Неопределено) Экспорт
	...
	ВсеКоллекции = ВсеКоллекцииОбъектовМД();
...
Функция ИменаПодчиненныхОбъектов(ИмяОбъекта) Экспорт
	...
	СвязиПоВладельцамСтроки = ЭтотОбъект.СвязиПоВладельцам.НайтиСтроки(Новый Структура("ИмяОбъекта", ИмяОбъекта));
...
// "Список_777_РегистрыСведений_777_РегистрСведений_777_ЦеныНоменклатуры_777_2"
//
...
Функция ВсеКоллекцииОбъектовМД()
